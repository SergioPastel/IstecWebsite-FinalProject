...
export default function LicenciaturasIndex({ courses, filters = {} }) {
  ...
  const banner = siteInfo?.pageBanners?.licenciatura ?? null;
            ...
            <div className="grid grid-cols-1 gap-4 lg:grid-cols-[1fr_220px]">
              <div className="relative">
                ...
                <input
                  value={query}
                  onChange={(e) => {
                    // Update query state and apply filters immediately on input change
              ...
              >
                <option value="relevance">
                  {t("courses.licenciatura.sortRelevance")}
                </option>
                        ...
                        <div className="mt-auto flex gap-3 pt-6">
                          ...
                          <button
                            ...
                            onClick={() => {
                              ...
                              router.visit(
                                route("applications.courses.apply", course),
                              );
                            }}
                          >
                            {t("courses.apply")}
