        ...
        <div className={`border-b border-white/10 ${isCollapsed ? "px-3 py-6" : "px-6 py-6"}`}>
          <div className={`flex ${isCollapsed ? "justify-center" : "items-start justify-between gap-3"}`}>
            ...
            <button
              ...
              className="hidden h-11 w-11 items-center justify-center rounded-2xl border border-white/10 bg-white/5 text-white transition hover:bg-white/10 md:inline-flex"
          ...
          {isCollapsed ? (
            <p className="mt-3 text-center text-[10px] font-semibold uppercase tracking-[0.28em] text-slate-300">
              Porto
            </p>
          ) : null}
        </div>
