...
class CourseCategorySeeder extends Seeder
{
    ...
    public function run(): void
    {
        $categories = [
            ...
            [
                'title' => ['pt' => 'Pós-Graduação'],
                'description' => ['pt' => 'Cursos de 2º ciclo do ensino superior, geralmente de 1 a 2 anos, destinados ao aprofundamento de conhecimentos numa área específica e à preparação para investigação ou funções specializadas.']
            ],        
        ];
